...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Liechtenstein Law MCP',
    version: context.version,
    jurisdiction: 'LI',
    description: 'Liechtenstein Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Liechtensteinisches Landesgesetzblatt',
        url: 'https://www.gesetze.li/konso',
        authority: 'Government of Liechtenstein',
      },
    ],
    freshness: {
