#!/usr/bin/env tsx
/**
 * Database builder for Liechtenstein Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Liechtenstein Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Liechtenstein statute text',
              );
