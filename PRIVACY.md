...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Liechtenstein bar chamber rules.
...
- LRK (Liechtensteinische Rechtsanwaltskammer) rules require strict confidentiality (Verschwiegenheitspflicht) and data processing controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/liechtenstein-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Liechtenstein)

### Liechtenstein Chamber of Lawyers Rules

Liechtenstein lawyers (Rechtsanwältinnen und Rechtsanwälte) are bound by strict confidentiality rules under the Rechtsanwaltsgesetz (RAG) and the Berufsordnung of the Liechtensteinische Rechtsanwaltskammer (LRK).
...
### Liechtenstein Data Protection Law and GDPR / EEA Equivalent

Under **GDPR Article 28** (applicable in Liechtenstein via the EEA Agreement) and the **Liechtenstein Data Protection Act (Datenschutzgesetz — DSG)**:
...
- Ensure adequate technical and organizational measures (technische und organisatorische Massnahmen, TOM)
- The Liechtenstein Data Protection Authority (Datenschutzstelle, datenschutzstelle.li) oversees compliance
...
```
Example: "What does the Liechtenstein General Civil Code (ABGB) say about contract formation?"
```
...
```
Example: "What are the penalties for insider trading under Liechtenstein financial market law?"
```
...
- Or use official sources (gesetze.li) directly
...
3. Client matters: Use official sources (gesetze.li) directly for authoritative text

### For Large Firms / Corporate Legal (Grosse Kanzleien / Rechtsabteilungen)
...
2. Follow Liechtenstein government IT security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/Liechtenstein-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **Datenschutzstelle Guidance**: Consult the Liechtenstein Data Protection Authority (datenschutzstelle.li) for EEA/GDPR compliance guidance
- **LRK Guidance**: Consult the Liechtensteinische Rechtsanwaltskammer for professional ethics guidance on AI tools
